...
#define SMC_PAD_NUMBER_UART1_RTS 167	/* GPIO_149 */
#define SMC_PAD_NUMBER_UART1_CTS 168	/* GPIO_150 */
...
#define DMA4_NUM_OF_CHANNELS 32
#define DMA4_CHANNEL_STRIDE 0x60
...
#define INTC_IRQ_GPTIMERn(n)  (36 + (n))	/* n = 1 to 11 */
