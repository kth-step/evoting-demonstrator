...
/******************************************************/
void createPlatform(const char *cpuname,
		    ...
		    icmProcessorP * cpu_, icmBusP * bus_)
{
	...
	const char *arm1_path =
	    icmGetVlnvString(0, "arm.ovpworld.org", 0, "arm", 0, "model");
	...
	icmProcessorP arm1_c =
	    icmNewProcessor("arm1", "arm", 0, 0, 32, arm1_path,
	...
	/* PSE cm */
	const char *cm_path =
	    icmGetVlnvString(0, 0, 0, "CoreModule9x6", 0, "pse");
	...
	/* PSE pit */
	const char *pit_path =
	    icmGetVlnvString(0, 0, 0, "IcpCounterTimer", 0, "pse");
	...
	/* PSE icp */
	const char *icp_path =
	    icmGetVlnvString(0, 0, 0, "IcpControl", 0, "pse");
	...
	/* PSE ld1 */
	const char *ld1_path =
	    icmGetVlnvString(0, 0, 0, "DebugLedAndDipSwitch", 0, "pse");
	...
	icmPseP kb1_p =
	    icmNewPSE("kb1", kb1_path, kb1_attr, kb1_pe, "modelAttrs");
	...
	icmPseP ms1_p =
	    icmNewPSE("ms1", ms1_path, ms1_attr, ms1_pe, "modelAttrs");
	...
	const char *uart1_path =
	    icmGetVlnvString(0, 0, 0, "UartPL011", 0, "pse");
	...
	/* PSE mmci */
	const char *mmci_path =
	    icmGetVlnvString(0, 0, 0, "MmciPL181", 0, "pse");
	const char *mmci_pe =
	    icmGetVlnvString(0, 0, 0, "MmciPL181", 0, "model");
	icmAttrListP mmci_attr = icmNewAttrList();

	icmPseP mmci_p =
	    icmNewPSE("mmci", mmci_path, mmci_attr, mmci_pe, "modelAttrs");
	...
	icmPseP lcd_p =
	    icmNewPSE("lcd", lcd_path, lcd_attr, lcd_pe, "modelAttrs");
